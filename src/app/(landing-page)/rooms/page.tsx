...
import { Typography } from "@/components/ui/typography"; // Added Typography for subtitle

export const metadata: Metadata = {
  title: "Available Rooms", // Updated title
  description: "Browse and find the perfect room for your needs.", // Updated description
  openGraph: {
    description: "Browse and find the perfect room for your needs.", // Updated OG description
  },
};
