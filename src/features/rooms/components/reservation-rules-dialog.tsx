    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogPortal>
        ...
        <DialogPrimitive.Content
          className={cn(
            "sm:max-w-[600px] max-h-[80vh] overflow-y-auto bg-white dark:bg-gray-900 border-2 border-blue-200 dark:border-blue-800",
                ...
                <div>
                  ...
                  <ul className="space-y-1 ml-4">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        Dapat dibatalkan kapan saja tanpa batasan waktu
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="w-1.5 h-1.5 rounded-full bg-amber-400 mt-2 flex-shrink-0"></div>
            ...
            <div className="p-4 rounded-lg border bg-red-50 dark:bg-red-950 border-red-200 dark:border-red-800">
              ...
              <ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Penting:</strong> Reservasi yang telah disetujui
                    hanya dapat dibatalkan sendiri jika masih tersisa lebih dari
                    24 jam sebelum waktu mulai
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                  <span>
                    Aturan ini diberlakukan untuk memberikan waktu yang cukup
                    bagi pengguna lain untuk memesan ruangan tersebut
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
            ...
            <div className="p-4 rounded-lg border bg-purple-50 dark:bg-purple-950 border-purple-200 dark:border-purple-800">
              ...
              <ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                ...
                <li className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                  <span>
                    Pembatalan berulang tanpa alasan yang jelas dapat
                    mempengaruhi prioritas persetujuan reservasi di masa depan
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
