    ...
    try {
      ...
      if (
        ...
        try {
          ...
          console.log(
            `Notification record created for reservation ${parseResult.data.reservationId}`
          );
        } catch (notificationError) {
          console.error(
            `Failed to create notification record for reservation ${parseResult.data.reservationId}:`,
            notificationError
          );
