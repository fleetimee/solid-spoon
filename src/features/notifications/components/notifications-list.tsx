      ...
      <div className="flex flex-col items-center justify-center py-16 text-center">
        ...
        <div className="space-y-3 max-w-md">
          ...
          <p className="text-muted-foreground leading-relaxed">
            {filter === "unread"
              ? "Semua sudah terbaca! Anda tidak memiliki notifikasi yang belum dibaca saat ini."
              : filter === "read"
                ? "Belum ada notifikasi yang dibaca. Notifikasi akan muncul di sini setelah Anda mulai berinteraksi dengan notifikasi."
                : "Pusat notifikasi Anda kosong. Notifikasi baru akan muncul di sini saat tiba."}
          </p>
        </div>
      </div>
    );
